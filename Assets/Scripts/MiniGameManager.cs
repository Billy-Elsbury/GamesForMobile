...
public class MiniGameManager : MonoBehaviour
{
    ...
    [Header("Google Sheets Logging")]
    public string googleAppsScriptURL = "https://script.google.com/macros/s/AKfycbzUpPiaR-YtdDpkbI2ySDm4adgYU1znh6f8exupsrRVDznNTnQAMRVAxxEWSPBDF9fG/exec";
